...
def main(args) -> None:
    ...
    elif args.model_type == "Cas9_mpnn":
        checkpoint_path = args.checkpoint_Cas9_mpnn
    elif args.model_type == "Luc7_mpnn":
        checkpoint_path = args.checkpoint_Luc7_mpnn
    ...
    if args.fixed_residues_multi:
        ...
        for pdb in pdb_paths:
            ...
            # print(fixed_residues_multi[pdb])
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        type=str,
        default="./model_params/Luc7mpnn_v_48_020.pt",
        help="Path to model weights.",
    )
    argparser.add_argument(
