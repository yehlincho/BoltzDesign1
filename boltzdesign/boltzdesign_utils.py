...
def boltz_hallucination(
    ...
    for b in batches:
        ...
        # Note: In PyTorch, simply assigning the tensor doesn't automatically link gradients 
        # if we re-assign later. We need to manage the optimizer on the shared tensor.
        ...
        if  non_protein_target:
            ...
            b['msa_mask'] = torch.ones(b['res_type'].shape[0], 1, b['res_type'].shape[1]).to(device)
